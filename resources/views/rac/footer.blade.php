...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- JS here -->
    <script src="{{ asset('clients/js/vendor/modernizr-3.5.0.min.js' ) }}"></script>
    ...
    <script src="{{ asset('clients/js/ajax-form.js' ) }}"></script>
    ...
    <script src="{{ asset('clients/js/gijgo.min.js' ) }}"></script>
